...
uex_api_url_local="http://localhost/uex/uex-v2/cli/input/"
uex_api_url_ptu="https://ptu.uexcorp.space/cli/input/"
uex_api_url_production="https://uexcorp.space/cli/input/"
